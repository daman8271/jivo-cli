...
## Wrong
After looking up a GRPO (or invoice, draft, vendor, PO) in Oil only, the AI told the operator 'GRPO not found'. The accountants and finance staff this toolkit is given to are not AI users: they hear that as a final answer, conclude 'it is not able to do it', and stop. The document simply lives in Mart or Beverages and the search was never finished.
...
A half-search is not an answer: never say a GRPO/invoice/draft/PO/vendor is 'not found' until ALL THREE companies (Oil, Mart, Beverages) are searched. Then say exactly what was checked and try the next key yourself — an operator who hears 'not found' concludes the tool cannot do it and stops.
