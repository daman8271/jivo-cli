...
export function validateInput(value: unknown): asserts value is Mark4Input {
  ...
  if (!Array.isArray(i.plan) || !i.plan.length || i.plan.length > 500 || !i.opening?.stock || !i.opening?.fg || !i.bom || !i.items || !i.lines || !Array.isArray(i.orders) || i.orders.length > 25000 || !Array.isArray(i.sources)) throw new Error("Input is incomplete or exceeds supported size.");
