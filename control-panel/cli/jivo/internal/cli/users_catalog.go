...
func newUsersCatalogCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "catalog",
		Short:       "Permission-module catalog used by the Users page — read-only, from the page's embedded JSON.",
		Example:     "  jivo-pp-cli users catalog",
		Annotations: map[string]string{"pp:endpoint": "users.catalog", "pp:method": "GET", "pp:path": "/users/", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun {
				data, err = extractHTMLResponse(data, htmlExtractionOptions{
					...
					LinkPrefixes:   []string{},
					Limit:          0,
					ScriptSelector: "script#um-catalog",
					JSONPath:       "",
				})
				if err != nil {
					return err
