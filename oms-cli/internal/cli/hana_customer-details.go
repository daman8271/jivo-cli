...
func newHanaCustomerDetailsCmd(flags *rootFlags) *cobra.Command {
	var flagCardCode string
	var flagBranch string

	cmd := &cobra.Command{
		Use:         "customer-details",
		Short:       "Customer master detail. Requires --card-code.",
		Example:     "  oms-pp-cli hana customer-details --card-code example-value --branch example-value",
		Annotations: map[string]string{"pp:endpoint": "hana.customer-details", "pp:method": "GET", "pp:path": "/api/hana/customer-details/", "mcp:read-only": "true"},
