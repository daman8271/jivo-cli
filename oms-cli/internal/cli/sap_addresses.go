...
func newSapAddressesCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "addresses",
		Short:       "SAP addresses",
		Example:     "  oms-pp-cli sap addresses",
		Annotations: map[string]string{"pp:endpoint": "sap.addresses", "pp:method": "GET", "pp:path": "/api/sap/addresses/", "mcp:read-only": "true"},
