...
func newHanaProductSoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "product-so",
		Short:       "BROKEN UPSTREAM (2026-08-04): the OMS backend raises 'get_sales_orders_for_product()",
		Example:     "  oms-pp-cli hana product-so --branch example-value --item-code example-value",
