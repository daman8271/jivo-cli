...
func newHanaStateChainCmd(flags *rootFlags) *cobra.Command {
	var flagBranch string

	cmd := &cobra.Command{
		Use:         "state-chain",
		Short:       "The state-to-state routing chain used for freight and GST place-of-supply decisions.",
		Example:     "  oms-pp-cli hana state-chain --branch example-value",
		Annotations: map[string]string{"pp:endpoint": "hana.state-chain", "pp:method": "GET", "pp:path": "/api/hana/state-chain/", "mcp:read-only": "true"},
