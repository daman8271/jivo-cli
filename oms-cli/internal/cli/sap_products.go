...
func newSapProductsCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "products",
		Short:       "SAP products",
		Example:     "  oms-pp-cli sap products",
		Annotations: map[string]string{"pp:endpoint": "sap.products", "pp:method": "GET", "pp:path": "/api/sap/products/", "mcp:read-only": "true"},
