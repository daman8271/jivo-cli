...
func newHanaVendorStatesCmd(flags *rootFlags) *cobra.Command {
	var flagBranch string

	cmd := &cobra.Command{
		Use:         "vendor-states",
		Short:       "States JIVO's vendors operate in, per branch — used to work out interstate vs intrastate GST.",
		Example:     "  oms-pp-cli hana vendor-states --branch example-value",
		Annotations: map[string]string{"pp:endpoint": "hana.vendor-states", "pp:method": "GET", "pp:path": "/api/hana/vendor-states/", "mcp:read-only": "true"},
