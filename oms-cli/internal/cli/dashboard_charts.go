...
func newDashboardChartsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "charts",
		Short:       "Dashboard chart series (visual overview, statewise)",
		Example:     "  oms-pp-cli dashboard charts",
		Annotations: map[string]string{"pp:endpoint": "dashboard.charts", "pp:method": "GET", "pp:path": "/api/orders/dashboardW/charts/", "mcp:read-only": "true"},
