...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "oms-pp-cli",
		Short: "Manage oms resources via the oms API",
		Long: `Manage oms resources via the oms API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'oms-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("oms-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'oms-pp-cli profile list')")
	...
	rootCmd.AddCommand(newQuotationsCmd(flags))
	rootCmd.AddCommand(newSapCmd(flags))
	rootCmd.AddCommand(newTrackerCmd(flags))
