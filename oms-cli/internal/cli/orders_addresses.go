...
func newOrdersAddressesCmd(flags *rootFlags) *cobra.Command {
	var flagCardCode string
	var flagCategory string

	cmd := &cobra.Command{
		Use:         "addresses",
		Short:       "Bill-to / ship-to addresses for a party. Requires --card-code.",
		Example:     "  oms-pp-cli orders addresses --card-code example-value",
		Annotations: map[string]string{"pp:endpoint": "orders.addresses", "pp:method": "GET", "pp:path": "/api/orders/addresses/", "mcp:read-only": "true"},
	...
	cmd.Flags().StringVar(&flagCategory, "category", "", "Optional category filter")
