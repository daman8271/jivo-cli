...
func newHanaSeriesCmd(flags *rootFlags) *cobra.Command {
	var flagBranch string

	cmd := &cobra.Command{
		Use:         "series",
		Short:       "SAP document numbering series for a branch — the series a document will draw its number from.",
		Example:     "  oms-pp-cli hana series --branch example-value",
		Annotations: map[string]string{"pp:endpoint": "hana.series", "pp:method": "GET", "pp:path": "/api/hana/series/", "mcp:read-only": "true"},
