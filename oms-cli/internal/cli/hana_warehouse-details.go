...
func newHanaWarehouseDetailsCmd(flags *rootFlags) *cobra.Command {
	var flagBranch string

	cmd := &cobra.Command{
		Use:         "warehouse-details",
		Short:       "Warehouse master for a branch: codes, names and locations behind every WhsCode you see in stock and batch data.",
		Example:     "  oms-pp-cli hana warehouse-details --branch example-value",
		Annotations: map[string]string{"pp:endpoint": "hana.warehouse-details", "pp:method": "GET", "pp:path": "/api/hana/warehouse-details/", "mcp:read-only": "true"},
