...
func newSapBranchesCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "branches",
		Short:       "SAP branches",
		Example:     "  oms-pp-cli sap branches",
		Annotations: map[string]string{"pp:endpoint": "sap.branches", "pp:method": "GET", "pp:path": "/api/sap/branches/", "mcp:read-only": "true"},
