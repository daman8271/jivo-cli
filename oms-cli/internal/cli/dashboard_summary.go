...
func newDashboardSummaryCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "summary",
		Short:       "Dashboard KPI block (total orders, total sales, completion)",
		Example:     "  oms-pp-cli dashboard summary",
		Annotations: map[string]string{"pp:endpoint": "dashboard.summary", "pp:method": "GET", "pp:path": "/api/orders/dashboardW/", "mcp:read-only": "true"},
