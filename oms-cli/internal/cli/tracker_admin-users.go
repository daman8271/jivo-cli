...
func newTrackerAdminUsersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "admin-users",
		Short:       "Tracker admin: users",
		Example:     "  oms-pp-cli tracker admin-users",
		Annotations: map[string]string{"pp:endpoint": "tracker.admin-users", "pp:method": "GET", "pp:path": "/api/tracker/admin/users/", "mcp:read-only": "true"},
