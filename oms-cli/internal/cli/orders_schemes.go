...
func newOrdersSchemesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "schemes",
		Short:       "Sales schemes / promotions",
		Example:     "  oms-pp-cli orders schemes",
		Annotations: map[string]string{"pp:endpoint": "orders.schemes", "pp:method": "GET", "pp:path": "/api/orders/schemes/", "mcp:read-only": "true"},
