...
func newHanaInvoiceDraftsCmd(flags *rootFlags) *cobra.Command {
	var flagBranch string

	cmd := &cobra.Command{
		Use:         "invoice-drafts",
		Short:       "READ of the A/R invoice drafts sitting in SAP for a branch. This reads drafts; it never creates one.",
		Example:     "  oms-pp-cli hana invoice-drafts --branch example-value",
		Annotations: map[string]string{"pp:endpoint": "hana.invoice-drafts", "pp:method": "GET", "pp:path": "/api/hana/invoice-drafts/", "mcp:read-only": "true"},
