...
func newAccountStatesCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "states",
		Short:       "List states",
		Example:     "  oms-pp-cli account states",
		Annotations: map[string]string{"pp:endpoint": "account.states", "pp:method": "GET", "pp:path": "/api/auth/states/", "mcp:read-only": "true"},
