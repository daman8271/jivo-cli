...
func newProductionExecutionReportsAnalyticsProcurementVsPlannedCmd(flags *rootFlags) *cobra.Command {
	var flagSapDocEntry int
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !cmd.Flags().Changed("sap-doc-entry") && !flags.dryRun {
				return fmt.Errorf("required flag \"%s\" not set", "sap-doc-entry")
			}
			...
			if flagSapDocEntry != 0 {
				params["sap_doc_entry"] = formatCLIParamValue(flagSapDocEntry)
			}
