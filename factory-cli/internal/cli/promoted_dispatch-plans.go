...
func newDispatchPlansPromotedCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "dispatch-plans",
		Short:       "GET /dispatch-plans/pipeline/ — dispatch plans pipeline",
		Long:        "GET /dispatch-plans/pipeline/ — dispatch plans pipeline",
		Example:     "  jivo-factory-pp-cli dispatch-plans",
