...
func newBlowingRunsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagDateFrom, "date-from", "", "inclusive; verified live on JIVO_OIL (YYYY-MM-DD)")
	cmd.Flags().StringVar(&flagDateTo, "date-to", "", "inclusive; verified live on JIVO_OIL (YYYY-MM-DD)")
	cmd.Flags().StringVar(&flagMachineId, "machine-id", "", "id from /blowing/machines/; verified live")
