...
func newGateCoreArrivalsExpectedCmd(flags *rootFlags) *cobra.Command {
	var flagVehicleId string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !cmd.Flags().Changed("vehicle-id") && !flags.dryRun {
				return fmt.Errorf("required flag \"%s\" not set", "vehicle-id")
			}
			...
			if flagVehicleId != "" {
				params["vehicle_id"] = formatCLIParamValue(flagVehicleId)
			}
