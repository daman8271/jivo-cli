...
func newProductionExecutionCostsAnalyticsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagDateFrom, "date-from", "", "YYYY-MM-DD. Verified live (72,319 B → 14,490 B).")
	cmd.Flags().StringVar(&flagDateTo, "date-to", "", "YYYY-MM-DD")
	cmd.Flags().IntVar(&flagLine, "line", 0, "Verified live: 72,319 B → 17,812 B with line=3 on OIL. int")
