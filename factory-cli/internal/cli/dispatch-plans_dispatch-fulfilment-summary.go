...
func newDispatchPlansDispatchFulfilmentSummaryCmd(flags *rootFlags) *cobra.Command {
	var flagFrom string
	var flagTo string
	...
	cmd.Flags().StringVar(&flagFrom, "from", "", "Optional server-side; omitting both gave from=2026-05-06 to=2026-08-03 on 2026-08-03, i.e. a ~90-day trailing default.")
