...
Resource scoping:
  ...
  jivo-factory-pp-cli sync

  # Sync specific resources only
  jivo-factory-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  jivo-factory-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  jivo-factory-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  jivo-factory-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  jivo-factory-pp-cli sync --latest-only`,
