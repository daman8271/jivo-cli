...
func newMaintenanceMaintenanceMaterialIndentsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagSearch, "search", "", "spans indent_no, purpose and item particulars — verified: search=STP matched 2 of 17")
	cmd.Flags().StringVar(&flagStatus, "status", "", "DRAFT | SUBMITTED | ISSUED | PENDING_APPROVAL | APPROVED | PURCHASED | GATE_IN | RECEIVED | REJECTED | CANCELLED —")
