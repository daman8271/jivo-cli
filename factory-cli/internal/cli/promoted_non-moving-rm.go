...
func newNonMovingRmPromotedCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "non-moving-rm",
		Short:       "GET /non-moving-rm/item-groups/ — non moving rm item groups",
		Long:        "GET /non-moving-rm/item-groups/ — non moving rm item groups",
		Example:     "  jivo-factory-pp-cli non-moving-rm",
