...
func newMarketplaceBatchesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagChannel, "channel", "", "FLIPKART|AMAZON. Honoured: FLIPKART=22 rows, AMAZON=1 row, unfiltered=23.")
