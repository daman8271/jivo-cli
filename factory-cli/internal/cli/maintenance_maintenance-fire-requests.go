...
func newMaintenanceMaintenanceFireRequestsCmd(flags *rootFlags) *cobra.Command {
	var flagStatus string
	var flagSearch string
	var flagIsActive bool

	cmd := &cobra.Command{
		Use:         "maintenance-fire-requests",
		Short:       "Requests for fire-safety items from the safety store, through issue, consumption and return of unused stock.",
		Example:     "  jivo-factory-pp-cli maintenance maintenance-fire-requests",
		Annotations: map[string]string{"pp:endpoint": "maintenance.maintenance-fire-requests", "pp:method": "GET", "pp:path": "/maintenance/fire-requests/", "mcp:read-only": "true"},
