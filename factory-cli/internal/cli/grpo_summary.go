...
func newGrpoSummaryCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "summary",
		Short:       "Material GRPO dashboard totals for one company — how many gate entries and POs are waiting to be posted",
