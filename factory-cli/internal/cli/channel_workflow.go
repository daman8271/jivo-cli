...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  jivo-factory-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"barcode", "barcode-dispatch-reports-pallets", "grpo", "maintenance", "notifications", "production-execution", "production-execution-checklist-templates"}
			totalSynced := 0
