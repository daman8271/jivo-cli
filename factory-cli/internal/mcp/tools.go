	...
	ctx := map[string]any{
		...
		"resources": []map[string]any{
			...
			},
			{
				...
				"endpoints":   []string{"arrival-slips", "inspections", "inspections-actionable", "inspections-awaiting-chemist", "inspections-awaiting-qam", "inspections-completed", "inspections-counts", "inspections-draft", "inspections-pending", "inspections-rejected", "inspections-return-to-vendor", "material-types", "print-documents", "production-qc", "production-qc-counts", "production-qc-pending", "production-qc-run-sessions", "qc-arrival-slip-get", "qc-inspection-get", "qc-inspections-decision-changed", "qc-material-type-get", "qc-material-type-parameters", "qc-online-monitoring", "qc-online-monitoring-get", "qc-online-monitoring-lines", "qc-online-monitoring-runs", "qc-online-monitoring-specs", "qc-parameter-get", "qc-print-document-get", "qc-production-running-runs", "qc-production-session-get", "sap-items"},
				"syncable":    true,
				"searchable":  true,
			},
			{
