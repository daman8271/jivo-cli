...
```bash
jivo-factory-pp-cli doctor --json
jivo-factory-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
jivo-factory-pp-cli which "<capability>" --json
jivo-factory-pp-cli <command> --help
```
...
```bash
jivo-factory-pp-cli <command> --agent
```
...
```bash
jivo-factory-pp-cli <command> --help
jivo-factory-pp-cli <command> --dry-run --agent
```
