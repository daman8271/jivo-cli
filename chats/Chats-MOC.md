...
## Sessions
- [[2026-08-21-gst-portal]] — **GST portal cracked → read-only CLI** (`portals/gst/`): 8 registrations, 7 of 8 logins verified live, 33 endpoints proven on 4 hosts, 36 commands in 12 groups. Haryana ITC ledger ₹8.44 Cr, Jul-26 3B outward ₹43.43 Cr, 2B B2B ITC ₹31.23 Cr. No auto-OCR (~50% exact); one login POST per process; Punjab's password is wrong and the CLI refuses to retry it.
