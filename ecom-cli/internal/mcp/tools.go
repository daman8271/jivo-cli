...
import (
	...
	"jivo-ecom-pp-cli/internal/cli"
	"jivo-ecom-pp-cli/internal/client"
	"jivo-ecom-pp-cli/internal/cliutil"
	"jivo-ecom-pp-cli/internal/config"
	"jivo-ecom-pp-cli/internal/mcp/cobratree"
	"jivo-ecom-pp-cli/internal/store"
)
		...
		if err != nil {
			...
			case strings.Contains(msg, "HTTP 400") && cliutil.LooksLikeAuthError(msg):
				return mcplib.NewToolResultError("authentication error: " + cliutil.SanitizeErrorBody(msg) +
					...
					"\n      Set your API key: export JIVO_ECOM_TOKEN=<your-key>" +
					"\n      Run 'jivo-ecom-pp-cli doctor' to check auth status."), nil
			case strings.Contains(msg, "HTTP 401"):
				return mcplib.NewToolResultError("authentication failed: " + cliutil.SanitizeErrorBody(msg) +
					"\nhint: check your token." +
					"\n      Set it with: export JIVO_ECOM_TOKEN=<your-key>" +
					"\n      Run 'jivo-ecom-pp-cli doctor' to check auth status."), nil
...
func newMCPClient() (*client.Client, error) {
	...
	cfgPath := filepath.Join(home, ".config", "jivo-ecom-pp-cli", "config.toml")
...
func dbPath() string {
	home, _ := os.UserHomeDir()
	return filepath.Join(home, ".local", "share", "jivo-ecom-pp-cli", "data.db")
}
...
func handleContext(_ context.Context, _ mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	ctx := map[string]any{
		...
		"resources": []map[string]any{
			...
			{
				"name":        "master",
				"description": "Master data: product catalogue and fulfilment centres",
				"endpoints":   []string{"fcs", "products"},
				"searchable":  true,
			},
			{
				"name":        "notifications",
				"description": "Read-only notifications with unread count",
				"endpoints":   []string{"get", "inventory-doh", "list"},
				"syncable":    true,
				"searchable":  true,
			},
			{
			...
			{
				"name":        "tables",
				"description": "Dynamic data-table browser over the underlying warehouse tables",
				"endpoints":   []string{"columns", "count", "counts", "data", "distinct"},
				"searchable":  true,
			},
			{
				"name":        "upload",
			...
			{
				"name":        "uploads",
				"description": "Upload job history (read-only)",
