...
func newDashboardPrimaryPoLitresCmd(flags *rootFlags) *cobra.Command {
	var flagMonth string
	var flagYear string

	cmd := &cobra.Command{
		Use:         "primary-po-litres",
		Short:       "Primary purchase-order volume in litres",
		Example:     "  jivo-ecom-pp-cli dashboard primary-po-litres",
		Annotations: map[string]string{"pp:endpoint": "dashboard.primary-po-litres", "pp:method": "GET", "pp:path": "/api/dashboard/primary-po-litres", "mcp:read-only": "true"},
