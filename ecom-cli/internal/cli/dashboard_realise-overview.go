...
func newDashboardRealiseOverviewCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Realise dashboard: overview (net realisation analytics)",
		Example:     "  jivo-ecom-pp-cli dashboard realise-overview",
		Annotations: map[string]string{"pp:endpoint": "dashboard.realise-overview", "pp:method": "GET", "pp:path": "/api/dashboard/realise-overview", "mcp:read-only": "true"},
