...
func newPlatformMpDashboardVersionCmd(flags *rootFlags) *cobra.Command {
	var flagPlatform string

	cmd := &cobra.Command{
		Use:         "mp-dashboard-version",
		Short:       "Data version stamp for a platform marketplace dashboard",
		Example:     "  jivo-ecom-pp-cli platform mp-dashboard-version --platform amazon",
		Annotations: map[string]string{"pp:endpoint": "platform.mp-dashboard-version", "pp:method": "GET", "pp:path": "/api/platform/{platform}/mp-dashboard-version", "mcp:read-only": "true"},
