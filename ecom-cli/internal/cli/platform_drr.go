...
func newPlatformDrrCmd(flags *rootFlags) *cobra.Command {
	var flagPlatform string
	var flagMonth int

	cmd := &cobra.Command{
		Use:         "drr",
		Short:       "Daily run-rate (DRR) dashboard for a platform",
		Example:     "  jivo-ecom-pp-cli platform drr --platform amazon",
		Annotations: map[string]string{"pp:endpoint": "platform.drr", "pp:method": "GET", "pp:path": "/api/platform/{platform}/drr-dashboard", "mcp:read-only": "true"},
