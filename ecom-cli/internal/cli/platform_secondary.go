...
func newPlatformSecondaryCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "secondary",
		Short:       "Secondary (sell-out) dashboard for a platform",
		Example:     "  jivo-ecom-pp-cli platform secondary --platform amazon",
		Annotations: map[string]string{"pp:endpoint": "platform.secondary", "pp:method": "GET", "pp:path": "/api/platform/{platform}/sec-dashboard", "mcp:read-only": "true"},
