...
func newDashboardSecondaryYoyGrowthCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Secondary sales year-over-year growth",
		Example:     "  jivo-ecom-pp-cli dashboard secondary-yoy-growth",
		Annotations: map[string]string{"pp:endpoint": "dashboard.secondary-yoy-growth", "pp:method": "GET", "pp:path": "/api/dashboard/secondary-yoy-growth", "mcp:read-only": "true"},
