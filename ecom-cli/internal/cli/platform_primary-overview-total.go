...
func newPlatformPrimaryOverviewTotalCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Primary overview totals across platforms",
		Example:     "  jivo-ecom-pp-cli platform primary-overview-total",
		Annotations: map[string]string{"pp:endpoint": "platform.primary-overview-total", "pp:method": "GET", "pp:path": "/api/platform/primary-overview-total", "mcp:read-only": "true"},
