...
func newPlatformSwiggyAdsDailyDashboardCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "swiggy-ads-daily-dashboard",
		Short:       "Swiggy Ads Daily Dashboard for a platform",
		Example:     "  jivo-ecom-pp-cli platform swiggy-ads-daily-dashboard --platform swiggy",
		Annotations: map[string]string{"pp:endpoint": "platform.swiggy-ads-daily-dashboard", "pp:method": "GET", "pp:path": "/api/platform/{platform}/swiggy-ads-daily-dashboard", "mcp:read-only": "true"},
