...
func newPlatformPrimarySummaryCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "primary-summary",
		Short:       "Primary sell-in summary across platforms",
		Example:     "  jivo-ecom-pp-cli platform primary-summary",
		Annotations: map[string]string{"pp:endpoint": "platform.primary-summary", "pp:method": "GET", "pp:path": "/api/platform/primary-summary", "mcp:read-only": "true"},
