...
func newPlatformStatsCmd(flags *rootFlags) *cobra.Command {
	var flagPlatform string

	cmd := &cobra.Command{
		Use:         "stats",
		Short:       "Headline stats for a platform (inventory, sells, open POs, active trucks)",
		Example:     "  jivo-ecom-pp-cli platform stats --platform amazon",
		Annotations: map[string]string{"pp:endpoint": "platform.stats", "pp:method": "GET", "pp:path": "/api/platform/{platform}/stats", "mcp:read-only": "true"},
