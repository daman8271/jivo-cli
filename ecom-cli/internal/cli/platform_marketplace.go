...
func newPlatformMarketplaceCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "marketplace",
		Short:       "Marketplace dashboard for a platform",
		Example:     "  jivo-ecom-pp-cli platform marketplace --platform amazon",
		Annotations: map[string]string{"pp:endpoint": "platform.marketplace", "pp:method": "GET", "pp:path": "/api/platform/{platform}/mp-dashboard", "mcp:read-only": "true"},
