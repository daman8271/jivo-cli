...
func newPlatformFlipkartAdsDashboardCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "flipkart-ads-dashboard",
		Short:       "Flipkart Ads Dashboard for a platform",
		Example:     "  jivo-ecom-pp-cli platform flipkart-ads-dashboard --platform flipkart",
		Annotations: map[string]string{"pp:endpoint": "platform.flipkart-ads-dashboard", "pp:method": "GET", "pp:path": "/api/platform/{platform}/flipkart-ads-dashboard", "mcp:read-only": "true"},
