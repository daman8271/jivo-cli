...
func newDashboardLeadTimeReportCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Distributor lead-time report (rows, slabs, grand total)",
		Example:     "  jivo-ecom-pp-cli dashboard lead-time-report",
		Annotations: map[string]string{"pp:endpoint": "dashboard.lead-time-report", "pp:method": "GET", "pp:path": "/api/dashboard/lead-time-report", "mcp:read-only": "true"},
