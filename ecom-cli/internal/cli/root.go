...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "jivo-ecom-pp-cli",
		Short: "Manage jivo-ecom resources via the jivo-ecom API",
		Long: `Manage jivo-ecom resources via the jivo-ecom API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'jivo-ecom-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("jivo-ecom-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'jivo-ecom-pp-cli profile list')")
	...
	rootCmd.AddCommand(newChatbotCmd(flags))
	...
	rootCmd.AddCommand(newPlatformCmd(flags))
	rootCmd.AddCommand(newReportsCmd(flags))
	rootCmd.AddCommand(newSapCmd(flags))
	rootCmd.AddCommand(newShipmentCmd(flags))
	rootCmd.AddCommand(newTablesCmd(flags))
