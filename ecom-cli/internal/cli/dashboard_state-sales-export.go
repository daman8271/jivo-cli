...
func newDashboardStateSalesExportCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "state-sales-export",
		Short:       "Export state-wise sales (file/CSV payload)",
		Example:     "  jivo-ecom-pp-cli dashboard state-sales-export --metric litres",
		Annotations: map[string]string{"pp:endpoint": "dashboard.state-sales-export", "pp:method": "GET", "pp:path": "/api/dashboard/state-sales/export", "mcp:read-only": "true"},
