...
func newSapDistributorInvoicesCmd(flags *rootFlags) *cobra.Command {
	var flagCode string
	var flagPage string
	...
	cmd := &cobra.Command{
		Use:         "distributor-invoices",
		Short:       "Invoices for a distributor by card code",
		Example:     "  jivo-ecom-pp-cli sap distributor-invoices --code example-value --card-code example-value",
		Annotations: map[string]string{"pp:endpoint": "sap.distributor-invoices", "pp:method": "GET", "pp:path": "/api/sap/distributor-invoices/{code}", "mcp:read-only": "true"},
