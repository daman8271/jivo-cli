...
func newPlatformBlinkitAdsDashboardCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "blinkit-ads-dashboard",
		Short:       "Blinkit Ads Dashboard for a platform",
		Example:     "  jivo-ecom-pp-cli platform blinkit-ads-dashboard --platform blinkit",
		Annotations: map[string]string{"pp:endpoint": "platform.blinkit-ads-dashboard", "pp:method": "GET", "pp:path": "/api/platform/{platform}/blinkit-ads-dashboard", "mcp:read-only": "true"},
