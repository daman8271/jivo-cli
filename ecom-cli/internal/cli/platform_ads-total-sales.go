...
func newPlatformAdsTotalSalesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "ads-total-sales",
		Short:       "Ads total-sales for a platform",
		Example:     "  jivo-ecom-pp-cli platform ads-total-sales --platform amazon",
		Annotations: map[string]string{"pp:endpoint": "platform.ads-total-sales", "pp:method": "GET", "pp:path": "/api/platform/{platform}/ads-total-sales", "mcp:read-only": "true"},
	...
	cmd.Flags().StringVar(&flagMetric, "metric", "", " (one of: ordered, shipped)")
