...
func newPlatformPriceCmd(flags *rootFlags) *cobra.Command {
	var flagPlatform string
	var flagDate string

	cmd := &cobra.Command{
		Use:         "price",
		Short:       "Pricing dashboard for a platform",
		Example:     "  jivo-ecom-pp-cli platform price --platform amazon",
		Annotations: map[string]string{"pp:endpoint": "platform.price", "pp:method": "GET", "pp:path": "/api/platform/{platform}/price-dashboard", "mcp:read-only": "true"},
