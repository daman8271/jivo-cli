...
func newPlatformBigbasketAdsDashboardCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "bigbasket-ads-dashboard",
		Short:       "Bigbasket Ads Dashboard for a platform",
		Example:     "  jivo-ecom-pp-cli platform bigbasket-ads-dashboard --platform bigbasket",
		Annotations: map[string]string{"pp:endpoint": "platform.bigbasket-ads-dashboard", "pp:method": "GET", "pp:path": "/api/platform/{platform}/bigbasket-ads-dashboard", "mcp:read-only": "true"},
