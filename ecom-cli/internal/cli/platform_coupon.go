...
func newPlatformCouponCmd(flags *rootFlags) *cobra.Command {
	var flagPlatform string
	var flagDate string

	cmd := &cobra.Command{
		Use:         "coupon",
		Short:       "Coupon performance dashboard for a platform",
		Example:     "  jivo-ecom-pp-cli platform coupon --platform amazon",
		Annotations: map[string]string{"pp:endpoint": "platform.coupon", "pp:method": "GET", "pp:path": "/api/platform/{platform}/coupon-dashboard", "mcp:read-only": "true"},
