...
func newShipmentV2FillOptionsCmd(flags *rootFlags) *cobra.Command {
	var flagChannel string
	var flagAppointmentId string

	cmd := &cobra.Command{
		Use:         "v2-fill-options",
		Short:       "What the v2 fill dialog may offer for one appointment: available stock",
		Example:     "  jivo-ecom-pp-cli shipment v2-fill-options",
		Annotations: map[string]string{"pp:endpoint": "shipment.v2-fill-options", "pp:method": "GET", "pp:path": "/api/shipment/v2/fill/options/", "mcp:read-only": "true"},
