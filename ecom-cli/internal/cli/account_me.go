...
func newAccountMeCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "me",
		Short:       "Show the authenticated user (profile, groups, platforms, permissions)",
		Example:     "  jivo-ecom-pp-cli account me",
		Annotations: map[string]string{"pp:endpoint": "account.me", "pp:method": "GET", "pp:path": "/api/auth/me", "mcp:read-only": "true"},
