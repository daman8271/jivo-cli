...
func newUploadPincodeMappingCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "pincode-mapping",
		Short:       "Pincode mapping table",
		Example:     "  jivo-ecom-pp-cli upload pincode-mapping",
		Annotations: map[string]string{"pp:endpoint": "upload.pincode-mapping", "pp:method": "GET", "pp:path": "/api/upload/pincode-mapping", "mcp:read-only": "true"},
