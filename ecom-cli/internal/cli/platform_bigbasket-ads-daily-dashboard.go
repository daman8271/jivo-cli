...
func newPlatformBigbasketAdsDailyDashboardCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "bigbasket-ads-daily-dashboard",
		Short:       "Bigbasket Ads Daily Dashboard for a platform",
		Example:     "  jivo-ecom-pp-cli platform bigbasket-ads-daily-dashboard --platform bigbasket",
		Annotations: map[string]string{"pp:endpoint": "platform.bigbasket-ads-daily-dashboard", "pp:method": "GET", "pp:path": "/api/platform/{platform}/bigbasket-ads-daily-dashboard", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("platform") {
				allowedPlatform := []string{"bigbasket"}
				validPlatform := false
	...
	cmd.Flags().StringVar(&flagPlatform, "platform", "", "Platform slug. This endpoint is served ONLY for: bigbasket (one of: bigbasket)")
