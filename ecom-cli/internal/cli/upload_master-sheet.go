...
func newUploadMasterSheetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "master-sheet",
		Short:       "Master sheet",
		Example:     "  jivo-ecom-pp-cli upload master-sheet",
		Annotations: map[string]string{"pp:endpoint": "upload.master-sheet", "pp:method": "GET", "pp:path": "/api/upload/master-sheet", "mcp:read-only": "true"},
