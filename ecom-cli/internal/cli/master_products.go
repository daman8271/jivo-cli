...
func newMasterProductsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "products",
		Short:       "List master products (paginated)",
		Example:     "  jivo-ecom-pp-cli master products",
		Annotations: map[string]string{"pp:endpoint": "master.products", "pp:method": "GET", "pp:path": "/api/master/products", "mcp:read-only": "true"},
