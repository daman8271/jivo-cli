...
func newUploadAdsMasterCmd(flags *rootFlags) *cobra.Command {
	var flagPage string
	var flagPageSize int

	cmd := &cobra.Command{
		Use:         "ads-master",
		Short:       "Ads master sheet (columns, rows)",
		Example:     "  jivo-ecom-pp-cli upload ads-master",
		Annotations: map[string]string{"pp:endpoint": "upload.ads-master", "pp:method": "GET", "pp:path": "/api/upload/ads-master", "mcp:read-only": "true"},
