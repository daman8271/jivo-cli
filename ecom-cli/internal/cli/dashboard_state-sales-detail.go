...
func newDashboardStateSalesDetailCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "state-sales-detail",
		Short:       "Detailed state-wise sales rows Server requires: state is required.",
		Example:     "  jivo-ecom-pp-cli dashboard state-sales-detail --metric litres",
		Annotations: map[string]string{"pp:endpoint": "dashboard.state-sales-detail", "pp:method": "GET", "pp:path": "/api/dashboard/state-sales/detail", "mcp:read-only": "true"},
