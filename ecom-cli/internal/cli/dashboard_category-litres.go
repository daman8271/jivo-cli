...
func newDashboardCategoryLitresCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "category-litres",
		Short:       "Category sales measured in litres",
		Example:     "  jivo-ecom-pp-cli dashboard category-litres",
		Annotations: map[string]string{"pp:endpoint": "dashboard.category-litres", "pp:method": "GET", "pp:path": "/api/dashboard/category-litres", "mcp:read-only": "true"},
