...
but do not stop the import.`,
  ...
  jivo-ecom-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  jivo-ecom-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | jivo-ecom-pp-cli import <resource> --input -`,
