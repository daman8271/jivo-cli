...
func newPlatformSwiggyAdsDashboardCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "swiggy-ads-dashboard",
		Short:       "Swiggy Ads Dashboard for a platform",
		Example:     "  jivo-ecom-pp-cli platform swiggy-ads-dashboard --platform swiggy",
		Annotations: map[string]string{"pp:endpoint": "platform.swiggy-ads-dashboard", "pp:method": "GET", "pp:path": "/api/platform/{platform}/swiggy-ads-dashboard", "mcp:read-only": "true"},
