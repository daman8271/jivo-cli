...
func newPlatformBlinkitSummaryReportCmd(flags *rootFlags) *cobra.Command {
	var flagPlatform string
	var flagYear int

	cmd := &cobra.Command{
		Use:         "blinkit-summary-report",
		Short:       "Blinkit summary report (get)",
		Example:     "  jivo-ecom-pp-cli platform blinkit-summary-report --platform blinkit",
		Annotations: map[string]string{"pp:endpoint": "platform.blinkit-summary-report", "pp:method": "GET", "pp:path": "/api/platform/{platform}/blinkit-summary-report", "mcp:read-only": "true"},
