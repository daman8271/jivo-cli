---
title: "EXIM endpoint — POST /license/dfia-license-header/create/"
created: 2026-07-19
updated: 2026-07-19
project: jivogpt
type: endpoint
...
method: POST
path: /license/dfia-license-header/create/
category: license
kind: write
...
|---|---|
| Method | `POST` |
| URL | `https://eximbe.jivo.in/license/dfia-license-header/create/` |
