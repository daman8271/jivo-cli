---
title: "EXIM endpoint — GET /jivo-rate/fetch/"
created: 2026-07-19
updated: 2026-07-19
project: jivogpt
type: endpoint
...
> Fetch/refresh latest JIVO pack rates; returns status + preview. [RECLASSIFIED: pull-and-store / sync-trigger — writes data, excluded from read CLI]
...
|---|---|
| Method | `GET` |
| URL | `https://eximbe.jivo.in/jivo-rate/fetch/` |
