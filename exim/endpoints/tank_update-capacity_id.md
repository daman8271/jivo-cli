---
title: "EXIM endpoint — PATCH /tank/update-capacity/{id}/"
created: 2026-07-19
updated: 2026-07-19
project: jivogpt
type: endpoint
...
|---|---|
| Method | `PATCH` |
| URL | `https://eximbe.jivo.in/tank/update-capacity/{id}/` |
