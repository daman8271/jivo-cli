---
title: "EXIM endpoint — PATCH /tank/item/update-color/{id}/"
created: 2026-07-19
updated: 2026-07-19
project: jivogpt
type: endpoint
...
method: PATCH
path: /tank/item/update-color/{id}/
category: tank
kind: write
...
# `PATCH /tank/item/update-color/{id}/`

> Update a tank item colour.
...
|---|---|
| Method | `PATCH` |
| URL | `https://eximbe.jivo.in/tank/item/update-color/{id}/` |
