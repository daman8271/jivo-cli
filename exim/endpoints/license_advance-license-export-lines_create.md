---
title: "EXIM endpoint — POST /license/advance-license-export-lines/create/"
created: 2026-07-19
updated: 2026-07-19
project: jivogpt
type: endpoint
...
method: POST
path: /license/advance-license-export-lines/create/
category: license
kind: write
...
# `POST /license/advance-license-export-lines/create/`
...
|---|---|
| Method | `POST` |
| URL | `https://eximbe.jivo.in/license/advance-license-export-lines/create/` |
