...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "exim-pp-cli",
		Short: "Manage exim resources via the exim API",
		Long: `Manage exim resources via the exim API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'exim-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("exim-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'exim-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSapSyncCmd(flags))
	rootCmd.AddCommand(newStockStatusCmd(flags))
	rootCmd.AddCommand(newTankCmd(flags))
	...
	rootCmd.AddCommand(newDirectorInventortyPromotedCmd(flags))
	rootCmd.AddCommand(newEximRatesPromotedCmd(flags))
	rootCmd.AddCommand(newJivoRatePromotedCmd(flags))
	rootCmd.AddCommand(newPartiesPromotedCmd(flags))
	rootCmd.AddCommand(newPartyPromotedCmd(flags))
	rootCmd.AddCommand(newSyncLogsPromotedCmd(flags))
