...
import (
	...
	"encoding/json"
	"errors"
	"exim-pp-cli/internal/client"
	"exim-pp-cli/internal/cliutil"
	"exim-pp-cli/internal/store"
	"fmt"
...
Resource scoping:
  ...
  exim-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  exim-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  exim-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  exim-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  exim-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("exim-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/exim-pp-cli/data.db)")
...
func syncResourceSinceParam(resource string) string {
	...
	case "daily-price":
		return "from_date"
	case "daily-price-highest-lowest":
		return "start_date"
	case "daily-price-trends":
		return "start_date"
	case "jivo-rate":
		return "from_date"
	case "rates-basic-rate":
		return "start_date"
	case "rates-market-rate-get":
		return "start_date"
	}
	return ""
}
...
func defaultSyncResources() []string {
	return []string{
		...
		"jivo-rate",
		"license",
		"license-advance-license-export-lines",
		"license-advance-license-import-lines",
		"parties",
		"rates",
		"rates-basic-rate",
		"rates-commodity",
		"rates-market-rate-get",
		"rates-market-rate-latest",
		"rates-rate-table-latest",
		"sap-sync",
		"sap-sync-balance-sheet",
		"sap-sync-custa-balance-sheet",
		"sap-sync-customer-aging-balance",
		"sap-sync-finished-inventory",
		"sap-sync-inventory",
		"sap-sync-open-ar",
		"sap-sync-open-pos",
		"sap-sync-planned-months",
		"sap-sync-vendor-balance-sheet",
		"stock-status",
		"stock-status-contractual-history",
		"stock-status-debit-entries",
		"stock-status-debit-insights",
		"stock-status-stock-dashboard",
		"stock-status-stock-insights",
		"stock-status-stock-summary",
		"sync-logs",
		"tank",
		"tank-capacity-insights",
		"tank-in-tank-items",
		"tank-item-wise-summary",
		"tank-items",
		"tank-log",
		"tank-tank-summary",
	}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"daily-price":                          "/daily-price/range/",
		"daily-price-db-list":                  "/daily-price/db-list/",
		"daily-price-highest-lowest":           "/daily-price/highest-lowest/",
		"daily-price-trends":                   "/daily-price/trends/",
		"dc":                                   "/dc/dropdown/",
		"director-inventorty":                  "/director-inventorty/",
		"exim-rates":                           "/exim-rates/fetch/",
		"items":                                "/items/fg/",
		"items-rm":                             "/items/rm/",
		"items-rm-summary":                     "/items/rm/summary/",
		"items-rm-varieties":                   "/items/rm/varieties/",
		"jivo-rate":                            "/jivo-rate/range/",
		"license":                              "/license/advance-license-headers/",
		"license-advance-license-export-lines": "/license/advance-license-export-lines/",
		"license-advance-license-import-lines": "/license/advance-license-import-lines/",
		"parties":                              "/parties/",
		"rates":                                "/rates/packing/",
		"rates-basic-rate":                     "/rates/basic-rate/",
		"rates-commodity":                      "/rates/commodity/",
		"rates-market-rate-get":                "/rates/market-rate/get/",
		"rates-market-rate-latest":             "/rates/market-rate/latest/",
		"rates-rate-table-latest":              "/rates/rate-table/latest/",
		"sap-sync":                             "/sap-sync/open-ap/",
		"sap-sync-balance-sheet":               "/sap-sync/balance-sheet/",
		"sap-sync-custa-balance-sheet":         "/sap-sync/custa/balance-sheet/",
		"sap-sync-customer-aging-balance":      "/sap-sync/customer-aging-balance/",
		"sap-sync-finished-inventory":          "/sap-sync/finished-inventory/",
		"sap-sync-inventory":                   "/sap-sync/inventory/",
		"sap-sync-open-ar":                     "/sap-sync/open-ar/",
		"sap-sync-open-pos":                    "/sap-sync/open-pos/",
		"sap-sync-planned-months":              "/sap-sync/planned-months/",
		"sap-sync-vendor-balance-sheet":        "/sap-sync/vendor/balance-sheet/",
		"stock-status":                         "/stock-status/stock-logs/",
		"stock-status-contractual-history":     "/stock-status/contractual-history/",
		"stock-status-debit-entries":           "/stock-status/debit-entries/",
		"stock-status-debit-insights":          "/stock-status/debit-insights/",
		"stock-status-stock-dashboard":         "/stock-status/stock-dashboard/",
		"stock-status-stock-insights":          "/stock-status/stock-insights/",
		"stock-status-stock-summary":           "/stock-status/stock-summary/",
		"sync-logs":                            "/sync_logs/",
		"tank":                                 "/tank/",
		"tank-capacity-insights":               "/tank/capacity-insights/",
		"tank-in-tank-items":                   "/tank/in-tank-items/",
		"tank-item-wise-summary":               "/tank/item-wise-summary/",
		"tank-items":                           "/tank/items/",
		"tank-log":                             "/tank/log/",
		"tank-tank-summary":                    "/tank/tank-summary/",
	}
