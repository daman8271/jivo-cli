-- oil_stock: one row per item x warehouse with any stock signal (JIVO Oil)
SELECT
...
JOIN JIVO_OIL_HANADB.OITM i  ON i."ItemCode"   = w."ItemCode"
LEFT JOIN JIVO_OIL_HANADB.OITB g ON g."ItmsGrpCod" = i."ItmsGrpCod"
LEFT JOIN JIVO_OIL_HANADB.OWHS h ON h."WhsCode"    = w."WhsCode"
